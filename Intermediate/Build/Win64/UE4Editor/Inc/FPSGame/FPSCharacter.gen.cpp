...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_isObjectivePickup_MetaData[];
#endif
		static void NewProp_isObjectivePickup_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_isObjectivePickup;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup_MetaData[] = {
		{ "Category", "Gameplay" },
		{ "ModuleRelativePath", "Public/FPSCharacter.h" },
	};
#endif
	void Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup_SetBit(void* Obj)
	{
		((AFPSCharacter*)Obj)->isObjectivePickup = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup = { UE4CodeGen_Private::EPropertyClass::Bool, "isObjectivePickup", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000014, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(AFPSCharacter), &Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFPSCharacter_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFPSCharacter_Statics::NewProp_isObjectivePickup,
	...
	IMPLEMENT_CLASS(AFPSCharacter, 4009239955);
